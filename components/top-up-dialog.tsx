  ...
  if (success) {
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent style={{ background: card, border: `1px solid ${border}`, borderRadius: 4, maxWidth: 380, padding: 0, overflow: "hidden" }}>
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent style={{
        ...
        {/* Header — single close button (the Dialog's built-in X handles closing) */}
        <div style={{ padding: "24px 24px 20px", borderBottom: `1px solid ${border}`, display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 36, height: 36, borderRadius: 4, display: "flex", alignItems: "center", justifyContent: "center",
        ...
        <div style={{ padding: "24px", display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 6, marginBottom: 10 }}>
              {PRESET_AMOUNTS.map(p => (
                <button key={p}
                  ...
                  style={{
                    padding: "10px 0", fontSize: 13, fontWeight: 700, borderRadius: 4, cursor: "pointer",
            ...
            <div style={{ position: "relative" }}>
              ...
              <input
                ...
                style={{
                  ...
                  borderRadius: 4, fontSize: 13, color: text, outline: "none",
            ...
            {customAmount && parseFloat(customAmount) < 50 && (
              <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 6, padding: "8px 10px",
                background: "rgba(239,68,68,0.08)", border: "1px solid rgba(239,68,68,0.2)", borderRadius: 4 }}>
              ...
              {([
                ...
                return (
                  <button key={m.id} onClick={() => setSelectedMethod(m.id)}
                    ...
                    <div style={{ width: 36, height: 36, borderRadius: 4, flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center",
          ...
          {/* Summary */}
          <div style={{ background: card2, border: `1px solid ${border}`, borderRadius: 4, padding: "14px 16px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {isValidAmount ? (
              ...
              <button disabled style={{
                ...
                border: `1px solid ${border}`, borderRadius: 4, color: subtle,
                cursor: "not-allowed",
              }}>
